...
export const COUNTRY_TZ: Record<string, string> = {
  ...
  Bahamas: 'America/Nassau', Bangladesh: 'Asia/Dhaka', Belarus: 'Europe/Minsk',
  Belgium: 'Europe/Brussels', Belize: 'America/Belize', Benin: 'Africa/Porto-Novo',
  Bhutan: 'Asia/Thimphu', Bolivia: 'America/La_Paz', 'Bosnia and Herz.': 'Europe/Sarajevo',
  ...
  Cyprus: 'Asia/Nicosia', Czechia: 'Europe/Prague', "Côte d'Ivoire": 'Africa/Abidjan',
  "Dem. Rep. Congo": 'Africa/Kinshasa', Denmark: 'Europe/Copenhagen', Djibouti: 'Africa/Djibouti',
  'Dominican Rep.': 'America/Santo_Domingo', Ecuador: 'America/Guayaquil', Egypt: 'Africa/Cairo',
  'El Salvador': 'America/El_Salvador', 'Eq. Guinea': 'Africa/Malabo',
  Eritrea: 'Africa/Asmara', Estonia: 'Europe/Tallinn', Ethiopia: 'Africa/Addis_Ababa',
  ...
  Ireland: 'Europe/Dublin', Israel: 'Asia/Jerusalem', Italy: 'Europe/Rome', // IANA has no alternative zone for Israel
  Jamaica: 'America/Jamaica', Japan: 'Asia/Tokyo', Jordan: 'Asia/Amman',
  Kazakhstan: 'Asia/Almaty', Kenya: 'Africa/Nairobi', Kuwait: 'Asia/Kuwait',
  ...
  'N. Macedonia': 'Europe/Skopje', Madagascar: 'Indian/Antananarivo', Malawi: 'Africa/Blantyre',
  Malaysia: 'Asia/Kuala_Lumpur', Mali: 'Africa/Bamako', Mauritania: 'Africa/Nouakchott',
  ...
  'North Korea': 'Asia/Pyongyang', Norway: 'Europe/Oslo', Oman: 'Asia/Muscat',
  ...
  Russia: 'Europe/Moscow', Rwanda: 'Africa/Kigali', 'S. Sudan': 'Africa/Juba',
  ...
  'Solomon Is.': 'Pacific/Guadalcanal', Somalia: 'Africa/Mogadishu',
  ...
  Thailand: 'Asia/Bangkok', 'Timor-Leste': 'Asia/Dili', Togo: 'Africa/Lome',
  'Trinidad and Tobago': 'America/Port_of_Spain', Tunisia: 'Africa/Tunis',
  ...
  'United States of America': 'America/New_York', Uruguay: 'America/Montevideo',
  Uzbekistan: 'Asia/Tashkent', Venezuela: 'America/Caracas', Vietnam: 'Asia/Ho_Chi_Minh',
  Yemen: 'Asia/Aden', Zambia: 'Africa/Lusaka', Zimbabwe: 'Africa/Harare', eSwatini: 'Africa/Mbabane',
};
