...
Data providers include [World Bank](https://data.worldbank.org/), [IMF PortWatch](https://portwatch.imf.org/), [FRED](https://fred.stlouisfed.org/), [Our World in Data](https://ourworldindata.org/), [V-Dem Institute](https://v-dem.net/), [Transparency International](https://www.transparency.org/en/cpi), [Reporters Without Borders](https://rsf.org/en/index), [UNDP Human Development](https://hdr.undp.org/), [UNHCR Refugee Data](https://www.unhcr.org/refugee-statistics/), [Open Exchange Rates](https://openexchangerates.org/), [Polymarket](https://polymarket.com/), and [REST Countries](https://restcountries.com/).
