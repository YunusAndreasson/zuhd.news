...
3. Synthesize a single article from multiple perspectives:
   ...
   - **One exception: a story whose only sources are state media or an advocacy outlet.** When every source in the entry is one of RT, TASS, Sputnik, RIA Novosti, Xinhua, CGTN, Global Times, China Daily, KCNA, Press TV, IRNA, Mehr, Tasnim, Fars, SANA, TRT World, Anadolu, the Saudi Press Agency, WAM, Responsible Statecraft, the Quincy Institute, Declassified UK or Inkstick, the body **must name the outlet and what it is** in the sentence carrying its central claim — "Russian state news agency TASS reported…", "Iran's state-affiliated Mehr News Agency put the toll at…", "Responsible Statecraft, the Quincy Institute's magazine, reported…". Its claims are its claims, never stated in the site's voice. An article from these sources that does not name the outlet is quarantined by the validator and does not publish. If a second, independent source in the entry carries the story, this exception does not apply and the normal rule does.
